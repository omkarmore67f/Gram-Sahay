  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 via-amber-50 to-emerald-100 flex items-center justify-center px-4 py-6">
      ...
      >
        ...
        {/* તાજેતરની નોટિસ અને અપડેટ્સ – placeholder */} 
        <motion.section
          variants={cardVariants}
        ...
        >
          <div className="flex items-center justify-between gap-2 mb-3">
            ...
            <span className="text-[11px] text-emerald-900/60">
              (ડેમો માહિતી – પછીથી backend જોડાશે)
            </span>
          </div>

          <div className="space-y-2">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-1.5 rounded-2xl bg-emerald-50/80 border border-emerald-100 px-3 py-2.5">
              <div>
                <p className="text-[11px] font-semibold text-emerald-900">
                  પાણી પુરવઠા સમયપત્રકમાં તાત્કાલિક ફેરફાર
                </p>
                <p className="text-[11px] text-emerald-900/75">
                  આવતી કાલથી આવતા ૩ દિવસ સુધી સવારે ૬ થી ૮ વચ્ચે પાણી પુરવઠો થશે.
                </p>
              </div>
              <p className="text-[11px] text-emerald-900/60 md:text-right">
                તારીખ: ૦૯ જાન્યુઆરી ૨૦૨૬
              </p>
            </div>

            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-1.5 rounded-2xl bg-amber-50/80 border border-amber-100 px-3 py-2.5">
              <div>
                <p className="text-[11px] font-semibold text-amber-900">
                  ગ્રામ સ્વચ્છતા અભિયાન – સ્વૈચ્છિક ભાગીદારી આમંત્રણ
                </p>
                <p className="text-[11px] text-amber-900/75">
                  રવિવારે સવારે ૭ વાગ્યે ગામના મુખ્ય ચૌકથી સ્વચ્છતા રેલી નીકળશે.
                </p>
              </div>
              <p className="text-[11px] text-amber-900/70 md:text-right">
                દિવસ: રવિવાર
              </p>
            </div>
          </div>
